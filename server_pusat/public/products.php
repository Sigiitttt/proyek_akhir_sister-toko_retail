...
$page = 'products'; // Untuk sidebar active
            ...
            <div class="col-lg-10 offset-lg-2 p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 page-header">
                    ...
                    <div class="d-flex gap-2">
                        <a href="export_produk.php" class="btn btn-success btn-sm shadow-sm">
                            <i class="fa-solid fa-file-csv me-2"></i>Export CSV
                        </a>
                        <button class="btn btn-info btn-sm text-white shadow-sm" data-bs-toggle="modal" data-bs-target="#modalImport">
                            <i class="fa-solid fa-file-import me-2"></i>Import
                        </button>
                        <button class="btn btn-primary btn-sm shadow-sm px-3" onclick="openModalAdd()">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        ...
                        <div class="alert alert-info small border-0 bg-info bg-opacity-10 text-info">
                            ...
                            Kode, Nama, Kategori, Satuan, Harga<br>
                            (Tanpa Header Row)
                        </div>
